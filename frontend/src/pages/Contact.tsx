              ...
              <Card className="p-6">
                ...
                {(info?.facebook || info?.instagram || info?.twitter || info?.youtube) && (
                  <div className="mt-5 flex gap-3">
                    {info?.facebook && <a href={info.facebook} target="_blank" rel="noreferrer" className="rounded-lg border border-slate-200 px-3 py-2 text-sm hover:bg-slate-50">{t("contact.facebook")}</a>}
                    {info?.instagram && <a href={info.instagram} target="_blank" rel="noreferrer" className="rounded-lg border border-slate-200 px-3 py-2 text-sm hover:bg-slate-50">{t("contact.instagram")}</a>}
                    {info?.twitter && <a href={info.twitter} target="_blank" rel="noreferrer" className="rounded-lg border border-slate-200 px-3 py-2 text-sm hover:bg-slate-50">{t("contact.twitter")}</a>}
                    {info?.youtube && <a href={info.youtube} target="_blank" rel="noreferrer" className="rounded-lg border border-slate-200 px-3 py-2 text-sm hover:bg-slate-50">{t("contact.youtube")}</a>}
                  </div>
                )}
              </Card>
